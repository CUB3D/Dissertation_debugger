                            ...
                            permissions: MemoryMapEntryPermissions {
                                ...
                                kind: match mp.permissions.kind {
                                    ptrace::MemoryMapEntryPermissionsKind::Private => {
                                        crate::memory_map::MemoryMapEntryPermissionsKind::Private
                                    }
                                    ptrace::MemoryMapEntryPermissionsKind::Shared => {
                                        crate::memory_map::MemoryMapEntryPermissionsKind::Shared
                                    }
                                },
                            },
                        })
                            ...
                            if status.wifstopped() {
                                ...
                                if stopsig == (libc::SIGTRAP | 0x80) {
                                    ...
                                    if event == 0 {
                                        ...
                                        if pid.ptrace_peektext(regs.ip as usize - 1) & 0xFF == 0xCC
                                        {
                                            println!(
                        ...
                        loop {
                            ...
                            if evt.dwDebugEventCode != 0 {
                                ...
                                unsafe {
                                    ...
                                    send_from_debug.send(DebuggerMsg::Trap {
                                        user_regs,
                                        fp_regs: Box::new(FpRegs {}),
                                    });
                                }
